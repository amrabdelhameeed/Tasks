...
//            print("Inside Inactive dates.");
          ...
          return DateWidget(
            ...
            dayTextStyle: isDeactivated
                ? deactivatedDayStyle.copyWith(color: AppColors.mainColor)
                : isSelected
                    ? selectedDayStyle
                    : widget.dayTextStyle.copyWith(color: AppColors.mainColor),
            width: widget.width,
...
class DatePickerController {
  ...
  double _calculateDateOffset(DateTime date) {
    final startDate = new DateTime(_datePickerState!.widget.startDate.year, _datePickerState!.widget.startDate.month, _datePickerState!.widget.startDate.day);
